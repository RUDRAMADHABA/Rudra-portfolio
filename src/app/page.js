...
const link4 = ()=>{
  window.open('https://topmate.io/rudramadhaba_mishra', '_blank');
    ...
    window.location.href = mailtoLink;
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible">
        <motion.div variants={typographyVariants}>
        <a href='/RudramadhabaResume.pdf' download> <Button variant="outlined" sx={{ border: "1px solid #ff8a56 !important", borderRadius: "5px", textTransform: "none", color: "#fff" }}>View Resume</Button></a>
        </motion.div>
        </motion.div>
      </Stack>
      <motion.div variants={containerVariants} initial="hidden" animate="visible">
